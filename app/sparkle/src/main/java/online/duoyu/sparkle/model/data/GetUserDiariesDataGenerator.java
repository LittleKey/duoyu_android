...
public class GetUserDiariesDataGenerator extends SparkleDataGenerator<DiariesResponse> {

  public GetUserDiariesDataGenerator(ApiType apiType, NameValuePair... pairs) {
    super(apiType, pairs);
  }
