...
// Source file: models/proto/business/user.proto at 30:1
...
public final class FollowRequest extends Message<FollowRequest, FollowRequest.Builder> {
  ...
  public boolean equals(Object other) {
    ...
    return unknownFields().equals(o.unknownFields()) && Internal.equals(user_id, o.user_id);
  }
  ...
  private static final class ProtoAdapter_FollowRequest extends ProtoAdapter<FollowRequest> {
    ...
    public int encodedSize(FollowRequest value) {
      return (value.user_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.user_id) : 0) + value.unknownFields().size();
    }
