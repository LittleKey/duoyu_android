...
public final class CorrectResponse extends Message<CorrectResponse, CorrectResponse.Builder> {
  ...
  @WireField(
      tag = 2,
      adapter = "online.duoyu.sparkle.model.business.CorrectResponse$Errno#ADAPTER"
  )
  ...
  public enum Errno implements WireEnum {
    ...
    public static Errno fromValue(int value) {
      switch (value) {
        ...
        case 1: return NOT_FOUND_DIARY;
        case 2: return INVALID_INFO;
        case 3: return CORRECT_EXISTED;
        default: return null;
      }
    }
