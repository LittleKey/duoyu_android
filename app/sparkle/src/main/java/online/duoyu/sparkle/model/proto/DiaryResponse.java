...
public final class DiaryResponse extends Message<DiaryResponse, DiaryResponse.Builder> {
  ...
  @WireField(
      tag = 2,
      adapter = "online.duoyu.sparkle.model.proto.DiaryResponse$Errno#ADAPTER")
  ...
  public boolean equals(Object other) {
    ...
    return unknownFields().equals(o.unknownFields()) && Internal.equals(success, o.success) && Internal.equals(errno, o.errno) && Internal.equals(diary, o.diary);
  }
  ...
  private static final class ProtoAdapter_DiaryResponse extends ProtoAdapter<DiaryResponse> {
    ...
    public int encodedSize(DiaryResponse value) {
      return (value.success != null ? ProtoAdapter.BOOL.encodedSizeWithTag(1, value.success) : 0) + (value.errno != null ? Errno.ADAPTER.encodedSizeWithTag(2, value.errno) : 0) + (value.diary != null ? Diary.ADAPTER.encodedSizeWithTag(3, value.diary) : 0) + value.unknownFields().size();
    }
