...
// Source file: models/proto/common.proto at 52:1
...
public final class Flag extends Message<Flag, Flag.Builder> {
  ...
  public Flag(Boolean is_admin, Boolean is_me, Boolean is_winner, Boolean is_selected, Boolean can_move, Boolean loading, Boolean is_ready, Boolean in_room, Boolean is_matching, Boolean is_liked, Boolean is_thumbnail, Boolean is_completed) {
    this(is_admin, is_me, is_winner, is_selected, can_move, loading, is_ready, in_room, is_matching, is_liked, is_thumbnail, is_completed, ByteString.EMPTY);
  }

  public Flag(Boolean is_admin, Boolean is_me, Boolean is_winner, Boolean is_selected, Boolean can_move, Boolean loading, Boolean is_ready, Boolean in_room, Boolean is_matching, Boolean is_liked, Boolean is_thumbnail, Boolean is_completed, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<Flag, Builder> {
    ...
    @Override
    public Flag build() {
      return new Flag(is_admin, is_me, is_winner, is_selected, can_move, loading, is_ready, in_room, is_matching, is_liked, is_thumbnail, is_completed, super.buildUnknownFields());
    }
  }
