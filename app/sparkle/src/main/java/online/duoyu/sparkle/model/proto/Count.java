...
// Source file: models/proto/common.proto at 40:1
...
public final class Count extends Message<Count, Count.Builder> {
  ...
  public Count(Float rating, Integer selected_num, Integer likes, Integer pages, Integer rating_count, Integer number, Integer width, Integer height, Integer x_offset, Integer score, Float progress, Integer position, Integer diaries, Integer corrects, Integer comments, Integer attentions, Integer followers, Integer followings) {
    this(rating, selected_num, likes, pages, rating_count, number, width, height, x_offset, score, progress, position, diaries, corrects, comments, attentions, followers, followings, ByteString.EMPTY);
  }

  public Count(Float rating, Integer selected_num, Integer likes, Integer pages, Integer rating_count, Integer number, Integer width, Integer height, Integer x_offset, Integer score, Float progress, Integer position, Integer diaries, Integer corrects, Integer comments, Integer attentions, Integer followers, Integer followings, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<Count, Builder> {
    ...
    @Override
    public Count build() {
      return new Count(rating, selected_num, likes, pages, rating_count, number, width, height, x_offset, score, progress, position, diaries, corrects, comments, attentions, followers, followings, super.buildUnknownFields());
    }
  }
