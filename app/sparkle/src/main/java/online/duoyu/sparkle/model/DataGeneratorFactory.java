...
import online.duoyu.sparkle.model.data.CorrectsDataGenerator;
import online.duoyu.sparkle.model.data.DiariesDataGenerator;
...
public class DataGeneratorFactory {
  ...
  createDataGenerator(ApiType apiType, List<String> paths, Bundle bundle, NameValuePair... pairs) {
    switch (apiType) {
      case RECENT_DIARY:
        return new DiariesDataGenerator(apiType);
      ...
      case GET_USER_PUBLISHED_CORRECTS:
        return new CorrectsDataGenerator(apiType, pairs);
      case GET_USER_PUBLISHED_DIARIES:
      case MY_PUBLISHED_DIARIES:
      case MY_ATTENDING_DIARIES:
        return new DiariesDataGenerator(apiType, pairs);
      default:
