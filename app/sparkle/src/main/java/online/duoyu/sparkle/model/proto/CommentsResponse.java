...
public final class CommentsResponse extends Message<CommentsResponse, CommentsResponse.Builder> {
  ...
  public boolean equals(Object other) {
    ...
    return unknownFields().equals(o.unknownFields()) && comments.equals(o.comments) && Internal.equals(cursor, o.cursor);
  }
  ...
  private static final class ProtoAdapter_CommentsResponse extends ProtoAdapter<CommentsResponse> {
    ...
    public int encodedSize(CommentsResponse value) {
      return Comment.ADAPTER.asRepeated().encodedSizeWithTag(1, value.comments) + (value.cursor != null ? Cursor.ADAPTER.encodedSizeWithTag(2, value.cursor) : 0) + value.unknownFields().size();
    }
    ...
    public CommentsResponse decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1; ) {
        switch (tag) {
          case 1:
            builder.comments.add(Comment.ADAPTER.decode(reader));
            break;
          case 2:
