...
// Source file: models/proto/business/diary.proto at 68:1
...
public final class AttenderRequest extends Message<AttenderRequest, AttenderRequest.Builder> {
  public static final ProtoAdapter<AttenderRequest> ADAPTER = new ProtoAdapter_AttenderRequest();
  ...
  public AttenderRequest(String diary_id, Cursor cursor) {
    this(diary_id, cursor, ByteString.EMPTY);
  }

  public AttenderRequest(String diary_id, Cursor cursor, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof AttenderRequest)) return false;
    AttenderRequest o = (AttenderRequest) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "AttenderRequest{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<AttenderRequest, Builder> {
    ...
    @Override
    public AttenderRequest build() {
      return new AttenderRequest(diary_id, cursor, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_AttenderRequest extends ProtoAdapter<AttenderRequest> {
    ProtoAdapter_AttenderRequest() {
      super(FieldEncoding.LENGTH_DELIMITED, AttenderRequest.class);
    }

    @Override
    public int encodedSize(AttenderRequest value) {
    ...
    @Override
    public void encode(ProtoWriter writer, AttenderRequest value) throws IOException {
    ...
    @Override
    public AttenderRequest decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public AttenderRequest redact(AttenderRequest value) {
