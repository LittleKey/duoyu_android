...
// Source file: models/proto/business/account.proto at 68:1
...
public final class ChangePasswordRequest extends Message<ChangePasswordRequest, ChangePasswordRequest.Builder> {
  ...
  public boolean equals(Object other) {
    ...
    return unknownFields().equals(o.unknownFields()) && Internal.equals(email, o.email) && Internal.equals(email_verification_code, o.email_verification_code) && Internal.equals(password, o.password);
  }
  ...
  private static final class ProtoAdapter_ChangePasswordRequest extends ProtoAdapter<ChangePasswordRequest> {
    ...
    public int encodedSize(ChangePasswordRequest value) {
      return (value.email != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.email) : 0) + (value.email_verification_code != null ? ProtoAdapter.STRING.encodedSizeWithTag(2, value.email_verification_code) : 0) + (value.password != null ? PrehashedPassword.ADAPTER.encodedSizeWithTag(3, value.password) : 0) + value.unknownFields().size();
    }
    ...
    public void encode(ProtoWriter writer, ChangePasswordRequest value) throws IOException {
      ...
      if (value.email_verification_code != null)
        ProtoAdapter.STRING.encodeWithTag(writer, 2, value.email_verification_code);
      if (value.password != null)
        PrehashedPassword.ADAPTER.encodeWithTag(writer, 3, value.password);
