...
public final class Model extends Message<Model, Model.Builder> implements Parcelable {
  ...
  public boolean equals(Object other) {
    ...
    Model o = (Model) other;
    return unknownFields().equals(o.unknownFields()) && Internal.equals(identity, o.identity) && Internal.equals(token, o.token) && Internal.equals(type, o.type) && Internal.equals(template, o.template) && Internal.equals(title, o.title) && Internal.equals(subtitle, o.subtitle) && Internal.equals(language, o.language) && Internal.equals(description, o.description) && Internal.equals(url, o.url) && Internal.equals(cover, o.cover) && Internal.equals(date, o.date) && Internal.equals(user, o.user) && Internal.equals(comment, o.comment) && Internal.equals(diary, o.diary) && Internal.equals(correct, o.correct) && Internal.equals(happening, o.happening) && Internal.equals(notification, o.notification) && subModels.equals(o.subModels) && Internal.equals(addition, o.addition);
  }
  ...
  private static final class ProtoAdapter_Model extends ProtoAdapter<Model> {
    ...
    public int encodedSize(Model value) {
      return (value.identity != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.identity) : 0) + (value.token != null ? ProtoAdapter.STRING.encodedSizeWithTag(2, value.token) : 0) + (value.type != null ? Type.ADAPTER.encodedSizeWithTag(3, value.type) : 0) + (value.template != null ? Template.ADAPTER.encodedSizeWithTag(4, value.template) : 0) + (value.title != null ? ProtoAdapter.STRING.encodedSizeWithTag(5, value.title) : 0) + (value.subtitle != null ? ProtoAdapter.STRING.encodedSizeWithTag(6, value.subtitle) : 0) + (value.language != null ? ProtoAdapter.STRING.encodedSizeWithTag(7, value.language) : 0) + (value.description != null ? ProtoAdapter.STRING.encodedSizeWithTag(8, value.description) : 0) + (value.url != null ? ProtoAdapter.STRING.encodedSizeWithTag(9, value.url) : 0) + (value.cover != null ? ProtoAdapter.STRING.encodedSizeWithTag(10, value.cover) : 0) + (value.date != null ? ProtoAdapter.STRING.encodedSizeWithTag(11, value.date) : 0) + (value.user != null ? User.ADAPTER.encodedSizeWithTag(12, value.user) : 0) + (value.comment != null ? Comment.ADAPTER.encodedSizeWithTag(13, value.comment) : 0) + (value.diary != null ? Diary.ADAPTER.encodedSizeWithTag(14, value.diary) : 0) + (value.correct != null ? Correct.ADAPTER.encodedSizeWithTag(15, value.correct) : 0) + (value.happening != null ? Happening.ADAPTER.encodedSizeWithTag(16, value.happening) : 0) + (value.notification != null ? Notification.ADAPTER.encodedSizeWithTag(17, value.notification) : 0) + Model.ADAPTER.asRepeated().encodedSizeWithTag(18, value.subModels) + (value.addition != null ? Model.ADAPTER.encodedSizeWithTag(19, value.addition) : 0) + value.unknownFields().size();
    }
    ...
    public void encode(ProtoWriter writer, Model value) throws IOException {
      ...
      if (value.description != null)
        ProtoAdapter.STRING.encodeWithTag(writer, 8, value.description);
      ...
      if (value.notification != null)
        Notification.ADAPTER.encodeWithTag(writer, 17, value.notification);
    ...
    public Model decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1; ) {
        switch (tag) {
          case 1:
            builder.identity(ProtoAdapter.STRING.decode(reader));
            break;
          case 2:
          ...
          case 5:
            ...
            break;
          case 6:
            builder.subtitle(ProtoAdapter.STRING.decode(reader));
            break;
          case 7:
          ...
          case 13:
            ...
            break;
          case 14:
            builder.diary(Diary.ADAPTER.decode(reader));
            break;
          case 15:
            builder.correct(Correct.ADAPTER.decode(reader));
            break;
          case 16:
            builder.happening(Happening.ADAPTER.decode(reader));
            break;
          case 17:
            builder.notification(Notification.ADAPTER.decode(reader));
            break;
          case 18:
            builder.subModels.add(Model.ADAPTER.decode(reader));
            break;
          case 19:
            builder.addition(Model.ADAPTER.decode(reader));
            break;
          default: {
    ...
    public Model redact(Model value) {
      ...
      if (builder.happening != null)
        builder.happening = Happening.ADAPTER.redact(builder.happening);
      if (builder.notification != null)
        builder.notification = Notification.ADAPTER.redact(builder.notification);
